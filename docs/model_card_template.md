...
* **Versión**: v1.0.0
* **Fecha de entrenamiento**: 2 de Setiembre 2026
* **Entrenado por**: Kevin Gonzales
...
Registradas automáticamente por `streamlit\_app/metrics.py` (`data/logs/interactions.jsonl`):

|Métrica|Valor|
|-|-|
|Latencia promedio de respuesta|88.65ms|
|Tool-calls promedio por turno|0.0|
|Tasa de éxito (sin errores)|0.0%|
|Tasa de error en tool-calls|700.0%|
|Feedback de usuarios (👍/👎)|0/0|
